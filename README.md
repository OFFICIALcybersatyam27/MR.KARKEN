...
<p align="center">
  <img src="https://github.com/OFFICIALcybersatyam27/MR.KARKEN/blob/master/.github/workflow.gif">
</p>

<p align="center">
  <img src="https://img.shields.io/badge/Version-2.3.5-green?style=for-the-badge">
  <img src="https://img.shields.io/github/license/htr-tech/Mr.karken?style=for-the-badge">
  <img src="https://img.shields.io/github/stars/htr-tech/Mr.karken-sry?style=for-the-badge">
  <img src="https://img.shields.io/github/issues/htr-tech/Mr.karken-sry?color=red&style=for-the-badge">
  <img src="https://img.shields.io/github/forks/htr-tech/Mr.karken-sry?color=teal&style=for-the-badge">
</p>
...
- Just, Clone this repository -
  ```
  git clone --depth=1 https://github.com/OFFICIALcybersatyam27/MR.KARKEN.git
  ```

- Now go to cloned directory and run `Mr.karken-sry.sh` -
  ```
  $ cd MR.KARKEN
  $ bash KARKEN.sh
  ```

- On first launch, It'll install the dependencies and that's it. ***MR.KARKEN*** is installed.

##

### Installation (Termux)
You can easily install Mr.karken-sry in Termux by using tur-repo
```
$ pkg install tur-repo
$ pkg install MR.KARKEN
$
```
### A Note : 
***Termux discourages hacking*** .. So never discuss anything related to *Mr.karken-sry* in any of the termux discussion groups. For more check : [wiki](https://wiki.termux.com/wiki/Hacking)

##

<p align="left">
  <a href="https://shell.cloud.google.com/cloudshell/open?cloudshell_git_repo=https://github.com/htr-tech/Mr.karken-sry.git&tutorial=README.md" target="_blank"><img src="https://gstatic.com/cloudssh/images/open-btn.svg"></a>
</p>
...
- Download `.deb` files from the [**Latest Release**](https://github.com/htr-tech/Mr.karken-sry/releases/latest)
...
- Docker Image Mirror:
  - **DockerHub** : 
    ```
    docker pull htrtech/Mr.karken-sry
    ```
  - **GHCR** : 
    ```
    docker pull ghcr.io/htr-tech/Mr.karken-sry:latest
    ```

- By using the wrapper script [**run-docker.sh**](https://raw.githubusercontent.com/htr-tech/Mr.karken-sry/master/run-docker.sh)

  ```
  $ curl -LO https://raw.githubusercontent.com/htr-tech/Mr.karken-sry/master/run-docker.sh
  $ bash run-docker.sh
  ```
- Temporary Container

  ```
  docker run --rm -ti htrtech/Mr.karken-sry
  ```
